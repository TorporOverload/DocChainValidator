...
def find_text_matches(original, modified):
    """
    ...
    def kmp_search(text, pattern):
        ...
        for i in range(len(text)):  # text index
    ...
    def find_common_substrings(text1, text2, min_length=10):
        ...
        # Generate potential patterns from text1 (words and phrases)
        words1 = text1.split()
        ...
        for i in range(len(words1) - 1):
            for phrase_len in range(2, min(6, len(words1) - i + 1)):  # Up to 5 words
    ...
    def calculate_similarity(text1, text2):
        ...
        # Use difflib for accurate similarity calculation
